...
Cuando la ETSI publicó la \textit{release} 4 de OSM, el cliente sufrió un gran lavado de cara. Se permitió una instalación única de OSMClient sin necesidad de instalar la versión completa de OSM, y se añadió una nueva versión del cliente que seguía el estándar sol005\cite{sol005item}, el cual define un nuevo formato de REST APIs para aplicaciones propias de la ETSI. También se mantuvo el formato correspodiente a las \textit{releases} 2, 3 para tener retrocompatibilidad con ellas.
