...
Por último, se hará una extensa explicación de cada una de las diferentes herramientas/aplicaciones que se han utilizado para llevar a cabo este proyecto (ONOS, ETSI-OSM y OpenStack), y de las librerías JAVA que se han empleado para poder realizar la interacción entre todos los componentes y llevar a cabo una prueba de concepto exitosa.
