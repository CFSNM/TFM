...
\bibitem{osmrel5bib}
OSM Release FIVE
\\\texttt{https://osm.etsi.org/wikipub/index.php/OSM\_Release\_FIVE}
...
J-OSM Client
\\\texttt{https://github.com/girtel/J-OSMClient}

\bibitem{onosjavadocbib}
ONOS Java API - 1.15.0
\\\texttt{http://api.onosproject.org/1.15.0/apidocs/}

\bibitem{openstack4jjavadocbib}
OpenStack4Java API - 3.0.5
\texttt{http://www.openstack4j.com/javadoc/}

\bibitem{metrohaulbib}
Metro-Haul Project
\texttt{https://metro-haul.eu/}
\end{thebibliography}
